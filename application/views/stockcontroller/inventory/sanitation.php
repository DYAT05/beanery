			...
			<section class="panel">
                <header class="panel-heading">
                    <h2 class="panel-title">
                        Updated List of Clearning and Sanitation
					</h2>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" name="inventory_cost" id="inventory_cost"  required value="<?= $item->inventory_cost ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                ...
                <div id="modalAddNewStock" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="category" value="sanitation" />
                            <input type="hidden" name="categorylink" value="<?= $categorylink ?>" />
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
