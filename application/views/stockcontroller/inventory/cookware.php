			...
			<section class="panel">
                ...
                <div id="modalAddNewStock" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="category" value="cookware" />
                            <input type="hidden" name="categorylink" value="<?= $categorylink ?>" />
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <!-- <input type="text" class="form-control" required name="unit_mode" id="unit_mode"  placeholder="Enter Unit/Mode..."> -->
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 text-left" for="beginning_inventory">Beginning Inventory:</label>
