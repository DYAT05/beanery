			...
			<section class="panel">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" <?= ($item->is_updated == 1) ? 'readonly' : ''; ?> class="form-control updatebeginning" name="beginning_inventory" id="beginning_inventory" attr-id="<?= $item->id ?>" required value="<?= $item->beginning_inventory ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" class="form-control" required name="minimum_stock" id="minimum_stock" value="<?= $item->minimum_stock ?>">
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                ...
                <div id="modalAddNewStock" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <input type="hidden" name="category" value="perishable" />
                            <input type="hidden" name="categorylink" value="<?= $categorylink ?>" />
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 text-left" for="beginning_inventory">Beginning Inventory:</label>
                                        <div class="col-md-9">
                                            <input type="number" class="form-control" required name="beginning_inventory" id="new_beginning_inventory"  placeholder="Enter Beginning Inventory...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 text-left" for="ending_inventory">Ending Inventory:</label>
...
<script>
    ...
    $('.stocklistedit').submit(function() {
        var re = confirm("Are you sure you want to update details?");
        return re;
    });
